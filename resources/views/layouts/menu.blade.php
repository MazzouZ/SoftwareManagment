...
@can('access_conge')
    <li class="nav-item nav-dropdown">
        ...
        <ul class="nav-dropdown-items">
             <li class="@if(Request::url() == url('conges')) active @endif">
