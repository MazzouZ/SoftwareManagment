            ...
            <div class="card-group">
                ...
                <div class="card text-white bg-primary py-5 d-md-down-none" style="width:44%">
                    <div class="card-body text-center">
                        <div>
                            <h2>SOFTWARE</h2>
                            <p>Plus de 1 000 utilisateurs de partout dans le monde nous ont rejoint et aiment notre produit !.
                                Aucun logiciel tiers n'est nécessaire. Vous devez simplement avoir votre navigateur et un compte d'utilisateur !
                            </p>
